# CONTEXT — auto-generated 2026-05-14 21:20:23 UTC
...
Backlog:
  - TICKET-M7 — Make tools/ scripts portable to macOS/BSD userland (issue #72)
...
- feat: TICKET-009-revised — EUR-native Manage Portfolio form (issue #21)
- feat: TICKET-010 — German capital-gains tax engine (issue #22)
- feat: TICKET-011 — Tax Dashboard page (issue #23)
- feat: TICKET-012 — Pre-trade sell simulator (issue #24)
- docs: queue TICKETs 021, 022a, 022b for charts work (issue #25)
- feat: TICKET-012 — Pre-trade sell simulator (issue #26)
- feat: TICKET-021 — Smooth ticker autocomplete (disk cache + streamlit-searchbox) (issue #27)
- feat: TICKET-023 — EUR price check + unsupported exchange suffixes (issue #28)
- ticket 024 sell simulator cold start (issue #29)
- docs: mark TICKET-024 as merged (issue #30)
...
- #72 — TICKET-M7 — Make tools/ scripts portable to macOS/BSD userland [high]
- #70 — TICKET-M6 — Consolidate AGENTS.md, restore SESSION_LOG.md, trim CONTEXT.md [high]
- #65 — TICKET-027 — Snapshot tab: header strip, 5Y price chart, KPI tiles with sparklines, valuation band, next catalyst [high]
...
- #71 — chore: consolidate AGENTS.md at root (merged 2026-05-14)
- #69 — chore: consolidate AGENTS.md at root (merged 2026-05-14)
- #68 — TICKET-M5 — Replace ticket-filing tooling with GitHub Projects board as source of truth (merged 2026-05-13)
- #66 — TICKET-026 — Company Deep Dive page shell (merged 2026-05-13)
- #63 — TICKET-M4b — Consolidate workflow files, execution-time menu, Vivek quick-reference (merged 2026-05-13)
- #61 — feat: TICKET-M4a — Auto-generated CONTEXT.md + chat verification protocol (merged 2026-05-13)
